 ...
 */
public class CustomDatePickerCir {
    ...
    public CustomDatePickerCir(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.custom_date_picker_cir);
