...
AppCompatActivity mActivity;
    ...
    private static final String BLUETOOTH_S = "00009012-0000-1000-8000-00805f9b34fb";
    private static final String BLUETOOTH_NOTIFY_C = "0000ffe2-0000-1000-8000-00805f9b34fb";
...
public void stopScan(){
    ...
    private void disConnection() {
        if (null == mAdapter || null == mBluetoothGatt) {
            ...
            return;
        }else if (mAdapter!=null&&mBluetoothGatt!=null){
            mBluetoothGatt.disconnect();
            mBluetoothGatt.close();
            reset();
        }
